...
$sourceCandidate = Join-Path $packageRoot "mt5\oppw_mt5_continuous_v50_1.py"
...
$targets = @(
    ...
    (Join-Path $resolvedRoot "mt5\oppw_mt5_continuous_v50_1.py"),
    (Join-Path $resolvedRoot "mt5\demo\oppw_mt5_continuous.py"),
    (Join-Path $resolvedRoot "mt5\demo\oppw_mt5_continuous_v50_1.py"),
    (Join-Path $resolvedRoot "mt5\real\oppw_mt5_continuous.py"),
    (Join-Path $resolvedRoot "mt5\real\oppw_mt5_continuous_v50_1.py")
)
...
Write-Host "OPPW MT5 v50.1 installed and verified."
