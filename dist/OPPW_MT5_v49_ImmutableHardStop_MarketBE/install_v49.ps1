...
$source = Join-Path $packageRoot "mt5\oppw_mt5_continuous_v49.py"
...
$targets = @(
    ...
    (Join-Path $resolvedRoot "mt5\oppw_mt5_continuous_v49.py"),
...
Write-Host "OPPW MT5 v49 installed."
Write-Host "Private account configs, state and logs were not overwritten."
