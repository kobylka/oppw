...
$source = Join-Path $packageRoot "mt5\oppw_mt5_continuous_v48_5.py"
...
$targets = @(
    ...
    (Join-Path $resolvedRoot "mt5\oppw_mt5_continuous_v48_5.py"),
...
Write-Host "OPPW MT5 v48.5 installed. Private configs were not changed."
