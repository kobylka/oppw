...
$source = Join-Path $packageRoot "mt5\oppw_mt5_continuous_v49_2.py"
...
$targets = @(
    ...
    (Join-Path $resolvedRoot "mt5\oppw_mt5_continuous_v49_2.py"),
...
Write-Host "OPPW MT5 v49.2 installed."
