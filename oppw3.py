    ...
    def process(self,quotes, stock, start_date, end_date, LEVERAGE, TP, SL, BE, debug, plots):
        ...
        for date in self.quotes:
            ...
            if(low < open_price*SL):
                ...
                trade_type = "TSL4"
            #elif(is_tuesday and open_price > 0 and close/open_price < 0.965):
            #    close_date = date
            #    close_price = opon
            #     trade_type = "TSLW"
            elif(low < open_price*SL):
                close_date = date
                close_price = open_price*SL
                trade_type = "SL"
...
if __name__ == "__main__":
    ...
    bench_weeks(26, sim, LEVERAGE, SL, BE)
    ...
    result = sim.process(sim_i.quotes, "QQQ", "20220103", "20260706", LEVERAGE, 0.96, SL, BE, True,True)
    #20100104