...
data class AnalyticsSummary(
    ...
    val afterTaxNetProfit: Double,
    val afterTaxCapitalAdjustedReturnPercent: Double,
    val positiveWeeksPercent: Double,
    val averageWeeklyProfit: Double,
    val windowCompoundedPreleverageReturnPercent: Double,
    val windowCompoundedLeveragedReturnPercent: Double,
    val weeklyGeometricPreleverageReturnPercent: Double,
    val weeklyGeometricLeveragedReturnPercent: Double,
