...
object SampleData {
    val response = MonitorResponse(
        ...
        snapshot = MonitorSnapshot(
            connection = ConnectionStatus(true, "2026-07-17T21:15:00+02:00", "OPPW-001", "2026-W29", "OK", "Friday Regular", "Tight stop loss (0.4%)", "CH / TO", "2026-07-17T21:59:57+02:00", 0.3, 0.5),
