    ...
    fun parseAnalytics(raw: String): AnalyticsResponse {
        ...
        return AnalyticsResponse(
            ...
            filters = AnalyticsFilters(
                ...
                allHistory = filters.optBoolean("allHistory"), windowEndDate = filters.optString("windowEndDate"),
                tradeClass = filters.optString("tradeClass"),
            ),
            filterOptions = AnalyticsFilterOptions(
                ...
                availableStartDate = options.optString("availableStartDate"), availableEndDate = options.optString("availableEndDate"),
            ...
            summary = AnalyticsSummary(
                ...
                weeklyGeometricPreleverageReturnPercent = summary.optDoubleAny("weeklyGeometricPreleverageReturnPercent"),
                weeklyGeometricLeveragedReturnPercent = summary.optDoubleAny("weeklyGeometricLeveragedReturnPercent"),
            ...
            drawdown = (root.optJSONObject("drawdown") ?: JSONObject()).let { value -> DrawdownAnalytics(
                ...
                maxDrawdownCurrency = value.optDoubleAny("maxDrawdownCurrency"),
                averageMaePercent = value.optDoubleAny("averageMaePercent"),
                averageDepthPercent = value.optDoubleAny("averageDepthPercent"),
                averageLengthSeconds = value.optDoubleAny("averageLengthSeconds"),
                longestLengthSeconds = value.optLong("longestLengthSeconds"),
                averageTroughRecoverySeconds = value.optDoubleAny("averageTroughRecoverySeconds"),
                timeUnderwaterPercent = value.optDoubleAny("timeUnderwaterPercent"),
                ulcerIndexPercent = value.optDoubleAny("ulcerIndexPercent"),
                ...
                series = buildList {
                    ...
                    for (i in 0 until values.length()) values.getJSONObject(i).let { item ->
                        ...
                        add(DrawdownPoint(
                            ...
                            equityIndex = item.optDoubleAny("equityIndex"),
                            drawdownPercent = item.optDoubleAny("drawdownPercent"),
                            maePercent = item.optDoubleAny("maePercent"),
                            capturedAt = capturedAt,
                            equity = item.optDoubleAny("equity"),
                            drawdownCurrency = item.optDoubleAny("drawdownCurrency"),
                            tradeKeys = item.optJSONArray("tradeKeys").toStrings(),
                ...
                episodes = buildList {
                    ...
                    for (i in 0 until values.length()) values.getJSONObject(i).let { item -> add(DrawdownEpisodeAnalytics(
                        ...
                        depthPercent = item.optDoubleAny("depthPercent"),
