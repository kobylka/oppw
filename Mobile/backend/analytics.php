...
$activityTimes=array_column($optionRows,'activity_at');foreach(['first_activity_at','latest_activity_at'] as $field)if(!empty($equityBounds[$field]))$activityTimes[]=(string)$equityBounds[$field];
